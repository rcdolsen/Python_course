...
CAMINHO_ZIP_DIR = CAMINHO_RAIZ / 'aula23_diretorio_zip'
CAMINHO_COMPACTADO = CAMINHO_RAIZ / 'aula23_compactado.zip'
CAMINHO_DESCOMPACTADO = CAMINHO_RAIZ / 'aula23_descompactado'
